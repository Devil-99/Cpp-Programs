...
int main()
{
    ...
    do
    {
      ...
      if(choice ==1 && square[1]=='1')
        ...
        square[3]=mark;
      else if(choice == 4 && square[2]==4)
        square[4]=mark;
      else if(choice == 5 && square[2]==5)
        square[5]=mark;
      else if(choice == 6 && square[2]==6)
        square[6]=mark;
      else if(choice == 7 && square[2]==7)
        square[7]=mark;
      else if(choice == 8 && square[2]==8)
        square[8]=mark;
...
/* Function to draw on tic tac toe board with players mark*/
void board()
{
